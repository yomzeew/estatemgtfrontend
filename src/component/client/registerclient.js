...
function Registerclient() {
  ...
  const handleSubmit=async()=>{
    ...
    const data={firstname:FirstName,lastname:LastName,address:address,state:StateOrigin,lga:lga,mobileno:MobileNo,altmobileno:AltMobileNo,email:Email,passcode:Password,nextofkindetails:convertstring}
    try{
      const response=await api.post('/api/addclient',data)
    ...
    <div className='w-screen flex justify-center h-auto pb-5'>
      ...
      <div className='w-full'>
        ...
        <div className='w-full flex justify-between items-center px-5'>
          <div>
            <button onClick={handleback}><span className='fa fa-2x fa-arrow-left text-green-900'></span></button>
          </div>
